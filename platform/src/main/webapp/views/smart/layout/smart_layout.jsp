...
<head>
  ...
  <!-- flowplayer -->
  <script src="${ctx}/views/smart/assets/flowplayer/js/flowplayer.min.js"></script>
  <!-- Flowplayer hlsjs engine -->
  <script src="${ctx}/views/smart/assets/flowplayer/js/flowplayer.hlsjs.min.js"></script>
  <!-- kendoUI -->
  <script src="${ctx}/views/smart/assets/kendoui/js/kendo.web.min.js"></script>
  <script src="${ctx}/views/smart/assets/kendoui/js/kendo.culture.zh-CN.js"></script>
  <script src="${ctx}/views/smart/assets/kendoui/js/kendo.messages.zh-CN.js"></script>
  <script src="${ctx}/views/smart/assets/kendoui/js/kendo.filtercell.js"></script>
  <script src="${ctx}/views/smart/assets/kendoui/js/kendo.columnsorter.js"></script>
  <!-- smart -->
...
<body>
  <div id="s-panel" class="${userSetting.pageWidth} ${userSetting.menuPosition}">
    ...
    <%@ include file="partial/left_panel.jsp"%>

    <%@ include file="partial/main_panel.jsp"%>
