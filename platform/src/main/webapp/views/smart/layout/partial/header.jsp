...
<header id='header'>
    <a class="header-logo" href="${ctx}" style="display: block;"></a>
    <div class="header-user">
        ...
        <a href="javascript:void(0);"><label class="fa fa-envelope"></label>消息<span>(<strong style='color:orange;'><%= 10 %></strong>)</span></a>
    </div>
