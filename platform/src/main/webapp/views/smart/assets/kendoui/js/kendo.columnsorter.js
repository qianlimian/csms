/**
 @description smart框架覆盖grid列排序源码，主要针对foreignkey column
...
(function (f, define) {
    ...
    (function ($, undefined) {
        ...
        var ColumnSorter = Widget.extend({
            ...
            refresh: function () {
                var that = this, sort = that.dataSource.sort() || [], idx, length, descriptor, dir, element = that.element, options = that.options, field = element.attr(kendo.attr(FIELD));
